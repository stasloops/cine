...
export const getAnime = (page: any) => {
    return async (dispatch: Dispatch) =>{
        try{
            const res = await axios.get(page === undefined ? `http://kodikapi.com/list?token=30ef128890b06e03700a3628b91c87c2&with_material_data=true&types=anime-serial&translation_id=609&sort=shikimori_rating&limit=28` : `${page}&with_material_data=true&types=anime-serial&translation_id=609&sort=shikimori_rating&limit=28`)
